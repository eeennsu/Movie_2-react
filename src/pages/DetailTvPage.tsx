...
import DefaultInfo from '../features/tv/detail/defaultInfo/DefaultInfo';
import Similar from '../features/tv/detail/similarMovie/sections/Similar';
...
const DetailTvPage = () => {
    ...
    const releaseFormat = useMemo(() => {
        let dateArr : Array<string> | undefined = data?.data.first_air_date.split('-');
    ...
    const country = useMemo(() => {
       return data?.data.production_countries[0]?.name || 'not found';
    }, [data]);
